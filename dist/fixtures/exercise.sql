...
insert ignore into exercise (id, name, description)
	values (1, 'Jogging', 'Jogging is a form of trotting or running at a slow or leisurely pace. The main intention is to increase physical fitness with less stress on the body.');
insert ignore into exercise (id, name, description)
	values (2, 'Running', 'Running is a method of terrestrial locomotion allowing humans and other animals to move rapidly on foot.');
...
insert ignore into exercise (id, name, equipment_id, description)
	values (8, 'Deadlift', 3, 'The deadlift is a weight training exercise in which a loaded barbell or bar is lifted off the ground to the level of the hips.');
